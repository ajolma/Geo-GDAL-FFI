...
$ffi->attach('GDALCreateCopy' => [qw/opaque string opaque int opaque opaque opaque/] => 'opaque');
$ffi->attach('GDALIdentifyDriver' => [qw/string opaque/] => 'opaque');
$ffi->attach('GDALIdentifyDriverEx' => ['string','unsigned int','string_pointer','string_pointer'] => 'opaque');
...
$ffi->attach('GDALClose' => [qw/opaque/] => 'void');
...
$ffi->attach('GDALBeginAsyncReader' => ['opaque','int','int','int','int','opaque','int','int','unsigned int','int','int*','int','int','int','string_pointer'] => 'opaque');
...
$ffi->attach('GDALDatasetRasterIOEx' => ['opaque','unsigned int','int','int','int','int','opaque','int','int','unsigned int','int','int*','unsigned int','unsigned int','unsigned int','opaque'] => 'int');
$ffi->attach('GDALDatasetAdviseRead' => ['opaque','int','int','int','int','int','int','unsigned int','int','int*','string_pointer'] => 'int');
...
$ffi->attach('GDALBuildOverviews' => [qw/opaque string int int* int int* opaque opaque/] => 'int');
$ffi->attach('GDALGetOpenDatasets' => [qw/opaque int*/] => 'void');
$ffi->attach('GDALGetAccess' => [qw/opaque/] => 'int');
$ffi->attach('GDALFlushCache' => [qw/opaque/] => 'void');
$ffi->attach('GDALCreateDatasetMaskBand' => [qw/opaque int/] => 'int');
$ffi->attach('GDALDatasetCopyWholeRaster' => [qw/opaque opaque string_pointer opaque opaque/] => 'int');
$ffi->attach('GDALRasterBandCopyWholeRaster' => [qw/opaque opaque string_pointer opaque opaque/] => 'int');
$ffi->attach('GDALRegenerateOverviews' => [qw/opaque int opaque string opaque opaque/] => 'int');
...
$ffi->attach('GDALDatasetCopyLayer' => [qw/opaque opaque string string_pointer/] => 'opaque');
$ffi->attach('GDALDatasetResetReading' => [qw/opaque/] => 'void');
$ffi->attach('GDALDatasetGetNextFeature' => [qw/opaque opaque double* opaque opaque/] => 'opaque');
...
$ffi->attach('GDALRasterAdviseRead' => ['opaque','int','int','int','int','int','int','unsigned int','string_pointer'] => 'int');
$ffi->attach('GDALRasterIO' => ['opaque','unsigned int','int','int','int','int','opaque','int','int','unsigned int','int','int'] => 'int');
$ffi->attach('GDALRasterIOEx' => ['opaque','unsigned int','int','int','int','int','opaque','int','int','unsigned int','unsigned int','unsigned int','opaque'] => 'int');
...
$ffi->attach('GDALGetRasterCategoryNames' => [qw/opaque/] => 'string_pointer');
$ffi->attach('GDALSetRasterCategoryNames' => [qw/opaque string_pointer/] => 'int');
...
$ffi->attach('GDALComputeRasterStatistics' => [qw/opaque int double* double* double* double* opaque opaque/] => 'int');
...
$ffi->attach('GDALComputeRasterMinMax' => [qw/opaque int double/] => 'void');
$ffi->attach('GDALFlushRasterCache' => [qw/opaque/] => 'int');
$ffi->attach('GDALGetRasterHistogram' => [qw/opaque double double int int* int int opaque opaque/] => 'int');
$ffi->attach('GDALGetRasterHistogramEx' => [qw/opaque double double int uint64* int int opaque opaque/] => 'int');
$ffi->attach('GDALGetDefaultHistogram' => [qw/opaque double* double* int* int* int opaque opaque/] => 'int');
$ffi->attach('GDALGetDefaultHistogramEx' => [qw/opaque double* double* int* uint64* int opaque opaque/] => 'int');
...
$ffi->attach('GDALComputeBandStats' => [qw/opaque int double* double* opaque opaque/] => 'int');
$ffi->attach('GDALOverviewMagnitudeCorrection' => [qw/opaque int opaque opaque opaque/] => 'int');
$ffi->attach('GDALGetDefaultRAT' => [qw/opaque/] => 'opaque');
$ffi->attach('GDALSetDefaultRAT' => [qw/opaque opaque/] => 'int');
$ffi->attach('GDALAddDerivedBandPixelFunc' => [qw/string opaque/] => 'int');
...
$ffi->attach('GDALExtractRPCInfo' => [qw/string_pointer opaque/] => 'int');
...
$ffi->attach('GDALRATValuesIOAsString' => ['opaque','unsigned int','int','int','int','string_pointer'] => 'int');
...
$ffi->attach('GDALDatasetGetVirtualMem' => ['opaque','unsigned int','int','int','int','int','int','int','unsigned int','int','int*','int','sint64','sint64','size_t','size_t','int','string_pointer'] => 'opaque');
$ffi->attach('GDALRasterBandGetVirtualMem' => ['opaque','unsigned int','int','int','int','int','int','int','unsigned int','int','sint64','size_t','size_t','int','string_pointer'] => 'opaque');
$ffi->attach('GDALGetVirtualMemAuto' => ['opaque','unsigned int','int*','sint64*','string_pointer'] => 'opaque');
$ffi->attach('GDALDatasetGetTiledVirtualMem' => ['opaque','unsigned int','int','int','int','int','int','int','unsigned int','int','int*','unsigned int','size_t','int','string_pointer'] => 'opaque');
$ffi->attach('GDALRasterBandGetTiledVirtualMem' => ['opaque','unsigned int','int','int','int','int','int','int','unsigned int','size_t','int','string_pointer'] => 'opaque');
$ffi->attach('GDALCreatePansharpenedVRT' => [qw/string opaque int opaque/] => 'opaque');
$ffi->attach('GDALGetJPEG2000Structure' => [qw/string string_pointer/] => 'opaque');
# from /home/ajolma/src/gdal/gdal/ogr/ogr_api.h
$ffi->attach('OGR_G_CreateFromWkb' => [qw/string opaque opaque int/] => 'int');
$ffi->attach('OGR_G_CreateFromWkt' => [qw/string_pointer opaque opaque/] => 'int');
$ffi->attach('OGR_G_CreateFromFgf' => [qw/string opaque opaque int int*/] => 'int');
...
$ffi->attach('OGR_G_ForceTo' => ['opaque','unsigned int','string_pointer'] => 'opaque');
...
$ffi->attach('OGR_G_ExportToGML' => [qw/opaque/] => 'string');
$ffi->attach('OGR_G_ExportToGMLEx' => [qw/opaque string_pointer/] => 'string');
...
$ffi->attach('OGR_G_ExportToKML' => [qw/opaque string/] => 'string');
$ffi->attach('OGR_G_ExportToJson' => [qw/opaque/] => 'string');
$ffi->attach('OGR_G_ExportToJsonEx' => [qw/opaque string_pointer/] => 'string');
...
$ffi->attach('OGR_G_GetLinearGeometry' => [qw/opaque double string_pointer/] => 'opaque');
$ffi->attach('OGR_G_GetCurveGeometry' => [qw/opaque string_pointer/] => 'opaque');
...
$ffi->attach('OGR_F_SetFieldBinary' => [qw/opaque int int pointer/] => 'void');
...
$ffi->attach('OGR_F_FillUnsetWithDefault' => [qw/opaque int string_pointer/] => 'void');
...
$ffi->attach('OGR_L_Intersection' => [qw/opaque opaque opaque string_pointer opaque opaque/] => 'int');
$ffi->attach('OGR_L_Union' => [qw/opaque opaque opaque string_pointer opaque opaque/] => 'int');
$ffi->attach('OGR_L_SymDifference' => [qw/opaque opaque opaque string_pointer opaque opaque/] => 'int');
$ffi->attach('OGR_L_Identity' => [qw/opaque opaque opaque string_pointer opaque opaque/] => 'int');
$ffi->attach('OGR_L_Update' => [qw/opaque opaque opaque string_pointer opaque opaque/] => 'int');
$ffi->attach('OGR_L_Clip' => [qw/opaque opaque opaque string_pointer opaque opaque/] => 'int');
$ffi->attach('OGR_L_Erase' => [qw/opaque opaque opaque string_pointer opaque opaque/] => 'int');
...
$ffi->attach('OGR_DS_CreateLayer' => ['opaque','string','opaque','unsigned int','string_pointer'] => 'opaque');
$ffi->attach('OGR_DS_CopyLayer' => [qw/opaque opaque string string_pointer/] => 'opaque');
...
$ffi->attach('OGR_Dr_CreateDataSource' => [qw/opaque string string_pointer/] => 'opaque');
$ffi->attach('OGR_Dr_CopyDataSource' => [qw/opaque opaque string string_pointer/] => 'opaque');
$ffi->attach('OGR_Dr_DeleteDataSource' => [qw/opaque string/] => 'int');
$ffi->attach('OGROpen' => [qw/string int opaque/] => 'opaque');
$ffi->attach('OGROpenShared' => [qw/string int opaque/] => 'opaque');
...
$ffi->attach('OSRFixupOrdering' => [qw/opaque/] => 'int');
$ffi->attach('OSRFixup' => [qw/opaque/] => 'int');
$ffi->attach('OSRStripCTParms' => [qw/opaque/] => 'int');
...
$ffi->attach('OSRImportFromESRI' => [qw/opaque string_pointer/] => 'int');
...
$ffi->attach('OSRImportFromOzi' => [qw/opaque string_pointer/] => 'int');
...
$ffi->attach('OSRConvertToOtherProjection' => [qw/opaque string string_pointer/] => 'opaque');
...
$ffi->attach('OSRFindMatches' => [qw/opaque string_pointer int* int*/] => 'opaque');
$ffi->attach('OSRFreeSRSArray' => [qw/opaque/] => 'void');
...
$ffi->attach('OCTProj4Normalize' => [qw/string/] => 'string');
$ffi->attach('OCTCleanupProjMutex' => [] => 'void');
$ffi->attach('OPTGetProjectionMethods' => [] => 'string_pointer');
$ffi->attach('OPTGetParameterList' => [qw/string string_pointer/] => 'string_pointer');
$ffi->attach('OPTGetParameterInfo' => [qw/string string string_pointer string_pointer double*/] => 'int');
