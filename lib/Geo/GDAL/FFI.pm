...
eval{$ffi->attach('GDALGroupGetVectorLayerNames' => [qw/opaque opaque/] => 'string_pointer');};
...
eval{$ffi->attach('OSRSetPROJAuxDbPaths' => [qw/string_pointer/] => 'void');};
eval{$ffi->attach('OSRGetPROJAuxDbPaths' => [] => 'string_pointer');};
