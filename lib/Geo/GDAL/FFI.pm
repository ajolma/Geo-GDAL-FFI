...
eval{$ffi->attach('GDALClose' => [qw/opaque/] => 'int');};
...
eval{$ffi->attach('GDALDatasetGetCompressionFormats' => [qw/opaque int int int int int int*/] => 'opaque');};
eval{$ffi->attach('GDALDatasetReadCompressedData' => [qw/opaque string int int int int int int* opaque size_t string_pointer/] => 'int');};
...
eval{$ffi->attach('GDALBuildOverviewsEx' => [qw/opaque string int int* int int* GDALProgressFunc opaque opaque/] => 'int');};
eval{$ffi->attach('GDALGetOpenDatasets' => [qw/uint64* int*/] => 'void');};
eval{$ffi->attach('GDALGetAccess' => [qw/opaque/] => 'int');};
eval{$ffi->attach('GDALFlushCache' => [qw/opaque/] => 'int');};
...
eval{$ffi->attach('GDALRasterBandCopyWholeRaster' => [qw/opaque opaque opaque GDALProgressFunc opaque/] => 'int');};
eval{$ffi->attach('GDALRegenerateOverviews' => [qw/opaque int uint64* string GDALProgressFunc opaque/] => 'int');};
eval{$ffi->attach('GDALRegenerateOverviewsEx' => [qw/opaque int uint64* string GDALProgressFunc opaque opaque/] => 'int');};
...
eval{$ffi->attach('GDALDatasetIsLayerPrivate' => [qw/opaque int/] => 'int');};
...
eval{$ffi->attach('GDALDatasetGetFieldDomainNames' => [qw/opaque opaque/] => 'opaque');};
eval{$ffi->attach('GDALDatasetGetFieldDomain' => [qw/opaque string/] => 'opaque');};
eval{$ffi->attach('GDALDatasetAddFieldDomain' => [qw/opaque opaque string_pointer/] => 'bool');};
eval{$ffi->attach('GDALDatasetDeleteFieldDomain' => [qw/opaque string string_pointer/] => 'bool');};
eval{$ffi->attach('GDALDatasetUpdateFieldDomain' => [qw/opaque opaque string_pointer/] => 'bool');};
eval{$ffi->attach('GDALDatasetGetRelationshipNames' => [qw/opaque opaque/] => 'opaque');};
eval{$ffi->attach('GDALDatasetGetRelationship' => [qw/opaque string/] => 'opaque');};
eval{$ffi->attach('GDALDatasetAddRelationship' => [qw/opaque opaque string_pointer/] => 'bool');};
eval{$ffi->attach('GDALDatasetDeleteRelationship' => [qw/opaque string string_pointer/] => 'bool');};
eval{$ffi->attach('GDALDatasetUpdateRelationship' => [qw/opaque opaque string_pointer/] => 'bool');};
eval{$ffi->attach('GDALDatasetSetQueryLoggerFunc' => [qw/opaque GDALQueryLoggerFunc opaque/] => 'bool');};
...
eval{$ffi->attach('GDALGetRasterNoDataValueAsInt64' => [qw/opaque int*/] => 'int');};
eval{$ffi->attach('GDALGetRasterNoDataValueAsUInt64' => [qw/opaque int*/] => 'uint64');};
eval{$ffi->attach('GDALSetRasterNoDataValue' => [qw/opaque double/] => 'int');};
eval{$ffi->attach('GDALSetRasterNoDataValueAsInt64' => [qw/opaque int/] => 'int');};
eval{$ffi->attach('GDALSetRasterNoDataValueAsUInt64' => [qw/opaque uint64/] => 'int');};
...
eval{$ffi->attach('GDALComputeRasterMinMax' => [qw/opaque int double/] => 'int');};
...
eval{$ffi->attach('GDALAddDerivedBandPixelFuncWithArgs' => [qw/string GDALDerivedPixelFunc string/] => 'int');};
...
eval{$ffi->attach('GDALIsMaskBand' => [qw/opaque/] => 'bool');};
...
eval{$ffi->attach('GDALDeinterleave' => ['opaque','unsigned int','int','opaque','unsigned int','size_t'] => 'void');};
...
eval{$ffi->attach('GDALExtractRPCInfoV1' => [qw/opaque opaque/] => 'int');};
eval{$ffi->attach('GDALExtractRPCInfoV2' => [qw/opaque opaque/] => 'int');};
...
eval{$ffi->attach('GDALRelationshipCreate' => ['string','string','string','unsigned int'] => 'opaque');};
eval{$ffi->attach('GDALDestroyRelationship' => [qw/opaque/] => 'void');};
eval{$ffi->attach('GDALRelationshipGetName' => [qw/opaque/] => 'string');};
eval{$ffi->attach('GDALRelationshipGetCardinality' => [qw/opaque/] => 'unsigned int');};
eval{$ffi->attach('GDALRelationshipGetLeftTableName' => [qw/opaque/] => 'string');};
eval{$ffi->attach('GDALRelationshipGetRightTableName' => [qw/opaque/] => 'string');};
eval{$ffi->attach('GDALRelationshipGetMappingTableName' => [qw/opaque/] => 'string');};
eval{$ffi->attach('GDALRelationshipSetMappingTableName' => [qw/opaque string/] => 'void');};
eval{$ffi->attach('GDALRelationshipGetLeftTableFields' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('GDALRelationshipGetRightTableFields' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('GDALRelationshipSetLeftTableFields' => [qw/opaque opaque/] => 'void');};
eval{$ffi->attach('GDALRelationshipSetRightTableFields' => [qw/opaque opaque/] => 'void');};
eval{$ffi->attach('GDALRelationshipGetLeftMappingTableFields' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('GDALRelationshipGetRightMappingTableFields' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('GDALRelationshipSetLeftMappingTableFields' => [qw/opaque opaque/] => 'void');};
eval{$ffi->attach('GDALRelationshipSetRightMappingTableFields' => [qw/opaque opaque/] => 'void');};
eval{$ffi->attach('GDALRelationshipGetType' => [qw/opaque/] => 'unsigned int');};
eval{$ffi->attach('GDALRelationshipSetType' => ['opaque','unsigned int'] => 'void');};
eval{$ffi->attach('GDALRelationshipGetForwardPathLabel' => [qw/opaque/] => 'string');};
eval{$ffi->attach('GDALRelationshipSetForwardPathLabel' => [qw/opaque string/] => 'void');};
eval{$ffi->attach('GDALRelationshipGetBackwardPathLabel' => [qw/opaque/] => 'string');};
eval{$ffi->attach('GDALRelationshipSetBackwardPathLabel' => [qw/opaque string/] => 'void');};
eval{$ffi->attach('GDALRelationshipGetRelatedTableType' => [qw/opaque/] => 'string');};
eval{$ffi->attach('GDALRelationshipSetRelatedTableType' => [qw/opaque string/] => 'void');};
...
eval{$ffi->attach('GDALExtendedDataTypeCreateStringEx' => [qw/size_t int/] => 'opaque');};
...
eval{$ffi->attach('GDALExtendedDataTypeGetSubType' => [qw/opaque/] => 'int');};
...
eval{$ffi->attach('GDALGroupGetMDArrayNames' => [qw/opaque opaque/] => 'opaque');};
...
eval{$ffi->attach('GDALGroupGetGroupNames' => [qw/opaque opaque/] => 'opaque');};
...
eval{$ffi->attach('GDALGroupGetVectorLayerNames' => [qw/opaque opaque/] => 'opaque');};
eval{$ffi->attach('GDALGroupOpenVectorLayer' => [qw/opaque string opaque/] => 'opaque');};
...
eval{$ffi->attach('GDALMDArrayAdviseReadEx' => [qw/opaque uint64* size_t opaque/] => 'int');};
...
eval{$ffi->attach('GDALMDArrayResize' => [qw/opaque uint64* opaque/] => 'bool');};
...
eval{$ffi->attach('GDALMDArrayGetNoDataValueAsInt64' => [qw/opaque int*/] => 'int');};
eval{$ffi->attach('GDALMDArrayGetNoDataValueAsUInt64' => [qw/opaque int*/] => 'uint64');};
...
eval{$ffi->attach('GDALMDArraySetNoDataValueAsInt64' => [qw/opaque int/] => 'int');};
eval{$ffi->attach('GDALMDArraySetNoDataValueAsUInt64' => [qw/opaque uint64/] => 'int');};
eval{$ffi->attach('GDALMDArraySetScale' => [qw/opaque double/] => 'int');};
eval{$ffi->attach('GDALMDArraySetScaleEx' => ['opaque','double','unsigned int'] => 'int');};
eval{$ffi->attach('GDALMDArrayGetScale' => [qw/opaque int*/] => 'double');};
eval{$ffi->attach('GDALMDArrayGetScaleEx' => ['opaque','int*','unsigned int'] => 'double');};
eval{$ffi->attach('GDALMDArraySetOffset' => [qw/opaque double/] => 'int');};
eval{$ffi->attach('GDALMDArraySetOffsetEx' => ['opaque','double','unsigned int'] => 'int');};
eval{$ffi->attach('GDALMDArrayGetOffset' => [qw/opaque int*/] => 'double');};
eval{$ffi->attach('GDALMDArrayGetOffsetEx' => ['opaque','int*','unsigned int'] => 'double');};
...
eval{$ffi->attach('GDALMDArrayGetResampled' => [qw/opaque size_t opaque int opaque opaque/] => 'opaque');};
eval{$ffi->attach('GDALMDArrayGetGridded' => [qw/opaque string opaque opaque opaque/] => 'opaque');};
eval{$ffi->attach('GDALMDArrayGetCoordinateVariables' => [qw/opaque size_t/] => 'uint64*');};
eval{$ffi->attach('GDALReleaseArrays' => [qw/uint64* size_t/] => 'void');};
eval{$ffi->attach('GDALMDArrayCache' => [qw/opaque opaque/] => 'int');};
...
eval{$ffi->attach('GDALAttributeReadAsStringArray' => [qw/opaque/] => 'opaque');};
...
# from ogr/ogr_api.h
eval{$ffi->attach('OGRGetGEOSVersion' => [qw/int* int* int*/] => 'bool');};
eval{$ffi->attach('OGR_G_CreateFromWkb' => [qw/string opaque uint64* int/] => 'int');};
eval{$ffi->attach('OGR_G_CreateFromWkbEx' => [qw/opaque opaque uint64* size_t/] => 'int');};
...
eval{$ffi->attach('OGR_G_ForceTo' => ['opaque','unsigned int','opaque'] => 'opaque');};
...
eval{$ffi->attach('OGR_G_WkbSizeEx' => [qw/opaque/] => 'size_t');};
...
eval{$ffi->attach('OGR_G_ConcaveHull' => [qw/opaque double bool/] => 'opaque');};
...
eval{$ffi->attach('OGR_G_UnaryUnion' => [qw/opaque/] => 'opaque');};
...
eval{$ffi->attach('OGR_G_MakeValidEx' => [qw/opaque opaque/] => 'opaque');};
eval{$ffi->attach('OGR_G_Normalize' => [qw/opaque/] => 'opaque');};
...
eval{$ffi->attach('OGR_G_GetLinearGeometry' => [qw/opaque double opaque/] => 'opaque');};
eval{$ffi->attach('OGR_G_GetCurveGeometry' => [qw/opaque opaque/] => 'opaque');};
...
eval{$ffi->attach('OGRHasPreparedGeometrySupport' => [] => 'int');};
eval{$ffi->attach('OGRCreatePreparedGeometry' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('OGRDestroyPreparedGeometry' => [qw/opaque/] => 'void');};
eval{$ffi->attach('OGRPreparedGeometryIntersects' => [qw/opaque opaque/] => 'int');};
eval{$ffi->attach('OGRPreparedGeometryContains' => [qw/opaque opaque/] => 'int');};
...
eval{$ffi->attach('OGR_Fld_GetDomainName' => [qw/opaque/] => 'string');};
eval{$ffi->attach('OGR_Fld_SetDomainName' => [qw/opaque string/] => 'void');};
eval{$ffi->attach('OGR_Fld_GetComment' => [qw/opaque/] => 'string');};
eval{$ffi->attach('OGR_Fld_SetComment' => [qw/opaque string/] => 'void');};
...
eval{$ffi->attach('OGR_F_StealGeometryEx' => [qw/opaque int/] => 'opaque');};
...
eval{$ffi->attach('OGR_F_GetFieldAsISO8601DateTime' => [qw/opaque int opaque/] => 'string');};
...
eval{$ffi->attach('OGR_F_FillUnsetWithDefault' => [qw/opaque int opaque/] => 'void');};
eval{$ffi->attach('OGR_F_Validate' => [qw/opaque int int/] => 'int');};
eval{$ffi->attach('OGR_FldDomain_Destroy' => [qw/opaque/] => 'void');};
eval{$ffi->attach('OGR_FldDomain_GetName' => [qw/opaque/] => 'string');};
eval{$ffi->attach('OGR_FldDomain_GetDescription' => [qw/opaque/] => 'string');};
eval{$ffi->attach('OGR_FldDomain_GetDomainType' => [qw/opaque/] => 'int');};
eval{$ffi->attach('OGR_FldDomain_GetFieldType' => [qw/opaque/] => 'unsigned int');};
eval{$ffi->attach('OGR_FldDomain_GetFieldSubType' => [qw/opaque/] => 'unsigned int');};
eval{$ffi->attach('OGR_FldDomain_GetSplitPolicy' => [qw/opaque/] => 'int');};
eval{$ffi->attach('OGR_FldDomain_SetSplitPolicy' => [qw/opaque int/] => 'void');};
eval{$ffi->attach('OGR_FldDomain_GetMergePolicy' => [qw/opaque/] => 'int');};
eval{$ffi->attach('OGR_FldDomain_SetMergePolicy' => [qw/opaque int/] => 'void');};
eval{$ffi->attach('OGR_CodedFldDomain_Create' => ['string','string','unsigned int','unsigned int','int'] => 'opaque');};
eval{$ffi->attach('OGR_CodedFldDomain_GetEnumeration' => [qw/opaque/] => 'int');};
eval{$ffi->attach('OGR_RangeFldDomain_Create' => ['string','string','unsigned int','unsigned int','opaque','bool','opaque','bool'] => 'opaque');};
eval{$ffi->attach('OGR_RangeFldDomain_GetMin' => [qw/opaque bool/] => 'opaque');};
eval{$ffi->attach('OGR_RangeFldDomain_GetMax' => [qw/opaque bool/] => 'opaque');};
eval{$ffi->attach('OGR_GlobFldDomain_Create' => ['string','string','unsigned int','unsigned int','string'] => 'opaque');};
eval{$ffi->attach('OGR_GlobFldDomain_GetGlob' => [qw/opaque/] => 'string');};
eval{$ffi->attach('OGR_L_GetName' => [qw/opaque/] => 'string');};
eval{$ffi->attach('OGR_L_GetGeomType' => [qw/opaque/] => 'unsigned int');};
eval{$ffi->attach('OGR_L_GetGeometryTypes' => [qw/opaque int int int* GDALProgressFunc opaque/] => 'opaque');};
...
eval{$ffi->attach('OGR_L_GetArrowStream' => [qw/opaque opaque opaque/] => 'bool');};
...
eval{$ffi->attach('OGR_L_UpsertFeature' => [qw/opaque opaque/] => 'int');};
eval{$ffi->attach('OGR_L_UpdateFeature' => [qw/opaque opaque int int* int int* bool/] => 'int');};
eval{$ffi->attach('OGR_L_GetLayerDefn' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('OGR_L_GetSpatialRef' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('OGR_L_GetSupportedSRSList' => [qw/opaque int int*/] => 'uint64*');};
eval{$ffi->attach('OGR_L_SetActiveSRS' => [qw/opaque int opaque/] => 'int');};
...
eval{$ffi->attach('OGR_L_AlterGeomFieldDefn' => [qw/opaque int opaque int/] => 'int');};
...
eval{$ffi->attach('OGR_L_Rename' => [qw/opaque string/] => 'int');};
...
eval{$ffi->attach('OGR_Dr_CreateDataSource' => [qw/opaque string opaque/] => 'opaque');};
eval{$ffi->attach('OGR_Dr_CopyDataSource' => [qw/opaque opaque string opaque/] => 'opaque');};
...
eval{$ffi->attach('OSRSetPROJSearchPaths' => [qw/opaque/] => 'void');};
eval{$ffi->attach('OSRGetPROJSearchPaths' => [] => 'opaque');};
eval{$ffi->attach('OSRSetPROJAuxDbPaths' => [qw/opaque/] => 'void');};
eval{$ffi->attach('OSRGetPROJAuxDbPaths' => [] => 'opaque');};
eval{$ffi->attach('OSRSetPROJEnableNetwork' => [qw/int/] => 'void');};
eval{$ffi->attach('OSRGetPROJEnableNetwork' => [] => 'int');};
...
eval{$ffi->attach('OSRImportFromESRI' => [qw/opaque opaque/] => 'int');};
...
eval{$ffi->attach('OSRImportFromOzi' => [qw/opaque opaque/] => 'int');};
...
eval{$ffi->attach('OSRExportToWktEx' => [qw/opaque string_pointer opaque/] => 'int');};
eval{$ffi->attach('OSRExportToPrettyWkt' => [qw/opaque string_pointer int/] => 'int');};
eval{$ffi->attach('OSRExportToPROJJSON' => [qw/opaque string_pointer opaque/] => 'int');};
...
eval{$ffi->attach('OSRStripVertical' => [qw/opaque/] => 'int');};
eval{$ffi->attach('OSRConvertToOtherProjection' => [qw/opaque string opaque/] => 'opaque');};
...
eval{$ffi->attach('OSRIsDynamic' => [qw/opaque/] => 'int');};
...
eval{$ffi->attach('OSRIsSameEx' => [qw/opaque opaque opaque/] => 'int');};
eval{$ffi->attach('OSRSetCoordinateEpoch' => [qw/opaque double/] => 'void');};
eval{$ffi->attach('OSRGetCoordinateEpoch' => [qw/opaque/] => 'double');};
...
eval{$ffi->attach('OSRFindMatches' => [qw/opaque opaque int* int*/] => 'uint64*');};
...
eval{$ffi->attach('OCTCoordinateTransformationOptionsSetDesiredAccuracy' => [qw/opaque double/] => 'int');};
eval{$ffi->attach('OCTCoordinateTransformationOptionsSetBallparkAllowed' => [qw/opaque int/] => 'int');};
...
eval{$ffi->attach('OCTClone' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('OCTGetSourceCS' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('OCTGetTargetCS' => [qw/opaque/] => 'opaque');};
eval{$ffi->attach('OCTGetInverse' => [qw/opaque/] => 'opaque');};
...
eval{$ffi->attach('OCTTransform4DWithErrorCodes' => [qw/opaque int double* double* double* double* int*/] => 'int');};
eval{$ffi->attach('OCTTransformBounds' => [qw/opaque double double double double double* double* double* double* int/] => 'int');};
...
eval{$ffi->attach('GDALMultiDimInfoOptionsNew' => [qw/opaque opaque/] => 'opaque');};
eval{$ffi->attach('GDALMultiDimInfoOptionsFree' => [qw/opaque/] => 'void');};
eval{$ffi->attach('GDALMultiDimInfo' => [qw/opaque opaque/] => 'string');};
eval{$ffi->attach('GDALMultiDimTranslateOptionsNew' => [qw/opaque opaque/] => 'opaque');};
...
eval{$ffi->attach('GDALVectorInfoOptionsNew' => [qw/opaque opaque/] => 'opaque');};
eval{$ffi->attach('GDALVectorInfoOptionsFree' => [qw/opaque/] => 'void');};
eval{$ffi->attach('GDALVectorInfo' => [qw/opaque opaque/] => 'string');};
